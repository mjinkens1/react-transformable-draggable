...
export const RotateHandleMouse = ({
    containerRef,
    containerTop,
    providerRef,
    rotation,
    ...
    useEffect(() => {
        const listenerCallback = event => {
            if (mouseDown) {
                ...
                setRotation(containerTop < 30 ? vectorAngle - 180 : vectorAngle)
            }
        }
    ...
    }, [centerCoords.pageX, centerCoords.pageY, containerTop, mouseDown, providerRef, rotation, setIsRotating, setRotation])
